            ...
            <div className="row justify-content-center">
                ...
                <div className="col-lg-7 text-center">
                  <div className="offer_content">
                      ...
                      Prix <span className="mr-4"><strong>{bestProduct && bestProduct.prix} </strong>dirhams</span>
                      <del>{bestProduct && (bestProduct.prix * 1.20).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')} dirhams</del>
                    </div>
                  </div>
                </div>
            </div>
